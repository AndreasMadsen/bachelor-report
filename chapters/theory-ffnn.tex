...
The equation ``how should $\delta_{h_1}$ be calculated ?'' then arises. This is done by using the chain rule again. This time the chain rule gives a sum because there are multiply paths to $a_{h_1}$. \todo{I don't fully understand this}
\begin{equation}
